...
rare_options = [
    ...
    ('unchoke_interval', 10,
     'interval time of choke algorithm applying'),
    ('scheduling_algorithm', 'EPFS',
     'enable new scheduling algorithm (BT or PFS or EPFS)'),
    ('EPFS_alpha', 0.02,
     'the weight used in the EWMA'),
    ('shutdown_after_seed', 1,
     'shutdown when leechers finish their downloads'),
    ('simultaneous_upload', 4,
     'simultaneous upload count'),
    ('test_id', "000",
     'prefix string of log filename'),
    ]
