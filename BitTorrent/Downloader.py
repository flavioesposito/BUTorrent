...
#This module contains all the machinery to download data from peers. 
...
class Downloader(object):
    ...
    def __init__(self, config, storage, picker, numpieces, downmeasure,
                 measurefunc, kickfunc, banfunc, logcollector):
        self.config = config
    ...
    def make_download(self, connection):
        ...
        d = SingleDownload(self, connection, self.logcollector)
